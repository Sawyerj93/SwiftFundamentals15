...
let favoriteBook = Book(title: "Sea Adventures", author: "John Doe", pages: 500, price: 35)
...
struct Laptop {
 ...
 var type: int
 var repairCount: Int
 var yearPurchase: int

 let personaLaptop = laptop(screenSize: 13, type: "", repairCount:0, yearPuchased: "")
