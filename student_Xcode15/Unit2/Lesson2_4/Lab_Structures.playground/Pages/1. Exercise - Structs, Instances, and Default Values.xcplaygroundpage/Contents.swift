...
favoriteBook.title = "Sea Adventures"
favoriteBook.author = "John Doe"
favoriteBook.pages = 500
favoriteBook.price = 35

print("\(favoriteBook.title) by \(favoriteBook.author) has a 50% discount. Now, it's only \(favoriteBook.price / 2) dollars")
