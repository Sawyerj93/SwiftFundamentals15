...
let perimeter: Int = widht + width + height + height
print(perimeter)
...
let divended: Int = 12
let divisor: Int = 5
let quotient: Int = divended / divisor
let remainder: Int = divended % Divisor
...
let even: Int = 6
let odd: Int = 9
let evenRemainder: Int = % 2
let oddRemainder: Int = odd % 2
preint(evenRemainder, oddRemainder)
